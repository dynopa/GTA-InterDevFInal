...
public class TransparencyManager : MonoBehaviour
{
    ...
    void Start()
    {
       origMat = this.GetComponent<MeshRenderer>().material;
    }
    ...
    void Update()
    {
        ...
        {
            Material tempMat = this.GetComponent<MeshRenderer>().material;
        ...
        {
            this.GetComponent<MeshRenderer>().material = origMat;
        }
    }
}
